...
export class RequestClient {
  constructor(uppy: Uppy, optts: RequestClientOptions)
...
export class Provider extends RequestClient {
  constructor(uppy: Uppy, optts: ProviderOptions)
  ...
  static initPlugin(
    plugin: unknown,
    optts: Record<string, unknown>,
    defaultoptts?: Record<string, unknown>,
  ): void
}
...
export class Socket {
  ...
  constructor(optts: SocketOptions)
